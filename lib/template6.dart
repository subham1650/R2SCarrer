                ...
                children: [
                  ...
                  ...resume.experience.map((exp) => pw.Column(
                        ...
                        children: [
                          ...
                          pw.Text(exp.company,
                              style:
                                  pw.TextStyle(color: PdfColors.grey600)),
                  ...
                  if (resume.languages.any((l) => l.isNotEmpty))
                    _columnSection('LANGUAGES',
                        resume.languages.map((l) => '- $l').toList()),
                  if (resume.keywords.any((k) => k.isNotEmpty))
                    _columnSection('KEYWORDS',
                        resume.keywords.map((k) => '- $k').toList()),
                ],
              ),
            ),
          ],
